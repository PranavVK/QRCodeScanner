...
import {Platform, StyleSheet, Text, View, ImageBackground, TouchableOpacity, TextInput, Button,Image,FlatList} from 'react-native';
  ...
  render() {
    return (
      <View style={styles.container}>
        <View style={{ width: deviceWidth, height: 60, backgroundColor: 'rgba(41,56,148,1)', marginTop:40}}>
